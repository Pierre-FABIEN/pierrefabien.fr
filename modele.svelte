...
Command: npx @threlte/gltf@2.0.3 C:/Web/Pierre-FABIEN/static/models/modele.glb --transform --draco /public/draco --output src/lib/models/MonModele.svelte --types --suspense
-->
...
<script lang="ts">
  ...
  const gltf = suspend(useGltf<GLTFResult>('/modele-transformed.glb', { useDraco: '/public/draco' }))
